    ...
    <div class="col-lg-8">
        <div class="panel panel-default bd-rad0 box-shadow">
            <div class="panel-body pd45">
                ...
                @if (Auth::user())
                    ...
                    {{ method_field('delete') }}
                        <ul class="list-inline">
                            <li class="pd0"><a href="{{ route('featured',[$features->id,$features->category]) }}"><img src="{{ asset('/img/featured.png') }}" class="ht60"></a></li>
                            <li class="pd0"><a href="{{ route('features.edit',$features->id) }}"><img src="{{ asset('/img/edit.png') }}" class="ht60"></a></li>
                ...
                <p>{{ $features->body }}</p>
                <div>
                    <span class="text-muted">Author: {{ $features->user }}</span> | <span class="text-muted">{{ date_format($features->created_at, 'F d Y') }}</span>
                </div>
            </div>
        </div>
        <div class="panel panel-default bd-rad0 box-shadow mgt40">
            <div class="panel-body pd45">  
                <form action="{{ route('features.comment',$features->id) }}" method="post" enctype="multipart/form-data" id="formSubmit">
                    {{ csrf_field() }}
                    <div class="mgb40">
