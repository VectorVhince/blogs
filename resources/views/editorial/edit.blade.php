                    ...
                    <form action="{{ route('editorial.update',$editorials->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            <div class="box-shadow">
                                <input type="text" name="title" class="form-control mgb20 bd-rad0" placeholder="Title" value="{{ $editorials->title }}">
                            </div>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            <div class="box-shadow">
                                <textarea name="body" class="form-control mgb20 bd-rad0 ht500" placeholder="Content">{{ $editorials->body }}</textarea>
                            </div>
                            @if ($errors->has('body'))
