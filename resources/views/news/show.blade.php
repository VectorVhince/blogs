            ...
            <div class="panel panel-default bd-rad0 box-shadow panel-bg">
                ...
                <div class="panel-body pdh45">
                    <div class="row mgb40">
                        ...
                        <div class="col-md-2">
                        @if (Auth::user())
                            @if (Auth::user()->id == $news->user_id || Auth::user()->role == 'superadmin')                                
                                <div class="dropdown" style="float: right;">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right mgt20" aria-labelledby="dropdownMenu1">
              ...
              <div class="panel-body pd15">
                  ...
                  @if(!$stories->isEmpty())
                    @foreach($stories as $story)
                      <a href="{{ route('news.show', $story->id) }}" class="fc-black dp-bl">
                        <div class="row mg0">
