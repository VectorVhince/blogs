                ...
                <div class="panel-body pdh45">
                    <div class="row mgb40">
                        <div class="col-md-10">
                            ...
                            <div class="dp-bl">
                                <span class="text-muted">Author: </span>{{ $sports->user }} <span class="text-muted mgl10">Posted: </span>{{ date_format($sports->created_at, 'F d, Y') }}
                            </div>
                        </div>
                        <div class="col-md-2">
                        @if (Auth::user())
                            @if (Auth::user()->id == $sports->user_id || Auth::user()->role == 'superadmin')                                
              ...
              <div class="panel-body pd15">
                  ...
                  @if(!$stories->isEmpty())
                    @foreach($stories as $story)
                      <a href="{{ route('sports.show', $story->id) }}" class="fc-black dp-bl">
                        <div class="row mg0">
