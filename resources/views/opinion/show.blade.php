...
@section('meta')
    ...
    <meta property="og:description"   content="{{ $opinion->body }}" />
    <meta property="og:image"         content="{{ asset('/img/uploads/' . $opinion->image) }}" />
@stop
            ...
            <div class="panel panel-default bd-rad0 box-shadow panel-bg">
                ...
                <div class="panel-body pdh45">
                    <div class="row mgb40">
                        ...
                        <div class="col-md-2">
                        @if (Auth::user())
                            @if (Auth::user()->id == $opinion->user_id || Auth::user()->role == 'superadmin')                                
              ...
              <div class="panel-body pd15">
                  ...
                  @if(!$stories->isEmpty())
                    @foreach($stories as $story)
                      <a href="{{ route('opinion.show', $story->id) }}" class="fc-black dp-bl">
                        <div class="row mg0">
...
<div id="modal3" class="modal fade bs-example-modal-sm pdt200" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content text-center pd15">
      ...
      <div class="row mgt20">
          <a href="{{ route('opinion.unfeatured',[$opinion->id]) }}"><button type="button" class="btn btn-danger btn-sm">Yes</button></a>
          <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">No</button>
      </div>
