    ...
    <div class="col-lg-9">
        <div class="panel panel-default bd-rad0 box-shadow">
            <div class="panel-body pd45">
                ...
                <div class="row mgb20">
                    <div class="col-md-12">
                        <span class="dp-bl fs25 fc-red">{{ $opinion->title }}</span>
                        <span class="text-muted">Author: {{ $opinion->user }}</span> | <span class="text-muted">{{ date_format($opinion->created_at, 'F d Y') }}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <img src="{{ asset('/img/uploads/' . $opinion->image) }}" class="img-responsive">
                    </div>
                    <div class="col-md-8">
                        <p>{{ substr($opinion->body,0,400) }}... <a href="{{ route('opinion.show', $opinion->id) }}" class="fc-gold">See More</a></p>
                    </div>
                </div>
                <hr>
                @endforeach
