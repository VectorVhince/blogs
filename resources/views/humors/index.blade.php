            ...
            <div class="panel-body pd45">
                ...
                <div class="row mgb20">
                    <div class="col-md-12">
                        ...
                        <span class="text-muted">Author: {{ $humor->user }}</span> | <span class="text-muted">{{ date_format($humor->created_at, 'F d Y') }}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <img src="{{ asset('/img/uploads/' . $humor->image) }}" class="img-responsive">
                    </div>
                    <div class="col-md-8">
                        <p>{{ substr($humor->body,0,400) }}...  <a href="{{ route('humors.show', $humor->id) }}" class="fc-gold">See More</a></p>
                    </div>
                </div>
                <hr>
                @endforeach
