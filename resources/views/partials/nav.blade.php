...
<div class="user-menu-container">
    <div class="dropup">
        <a href="#" class="dropdown-toggle fc-black" data-toggle="dropdown" role="button" aria-expanded="false" id="dropdownMenu2">
            <div class="user-menu">
                <div class="notification-container">
                    <span class="notification-count">{{ $notifs->count() }}</span> <i class="glyphicon glyphicon-user fc-white"></i>
                </div>
            </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownMenu2">
            ...
            <li><a href="{{ route('pending.posts') }}"><span class="glyphicon glyphicon-time"></span> Pending Posts {{ $notifs->where('category','pending')->count() }}</a></li>
